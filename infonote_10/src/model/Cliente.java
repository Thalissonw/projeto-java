...
public String toString() {
	...
	retValue = "Informações sobre o cliente: " + ENTER + super.toString() + "Código do Cliente:" + codigoCliente + ENTER +
			"Nome:"+ nome + ENTER + "E-mail:" + email + ENTER + "Telefone:" + telefone + ENTER + "Endereco: " + enderecos[0];
...
public Cliente(String login, String senha, int tipo, String codigoCliente,String nome, String email,String telefone,Endereco endereco) {
	...
	this.email = email;
	this.telefone = telefone;
	//inserir na posição zero do vetor o endereço residencial
